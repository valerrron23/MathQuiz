...
namespace MathQuiz
{
    public partial class Form1 : Form
    {
        ...
        private void sum_ValueChanged(object sender, EventArgs e)
        {
            if (addend1 + addend2 != sum.Value)
            {
                System.Media.SoundPlayer player = new System.Media.SoundPlayer(@"c:\sounds\error.wav");
                player.Play();
            }
            else
            {
                System.Media.SoundPlayer player = new System.Media.SoundPlayer(@"c:\sounds\success.wav");
                player.Play();
            }
        }
